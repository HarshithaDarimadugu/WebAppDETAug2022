...
namespace MVCDemo.Controllers
{
    public class FriendsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FriendId,FriendName,Place")] Friends friend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FriendId,FriendName,Place")] Friends friend)
        {
